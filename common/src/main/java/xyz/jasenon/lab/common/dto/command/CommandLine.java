...
public enum CommandLine {
    ...
    REQUEST_AIR_CONDITION_DATA_RS485(new Command("{0} {1} FF FF FF FF FF FF FF",CheckType.SUM,SendType.MQTT),"请求空调数据"),
    ...
    REQUEST_LIGHT_DATA(new Command("{0} 03 {1} 00 00 00",CheckType.SUM,SendType.MQTT), "请求灯光数据"),
