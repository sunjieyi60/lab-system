...
public enum CommandLine {
    ...
    OPEN_ACCESS_ONCE(new Command("{0} 0A 02 FF 00 00",CheckType.SUM_UNSG,SendType.MQTT),"单次开门"),
    CLOSE_ACCESS_ONCE(new Command("{0} 0A 02 00 00 00",CheckType.SUM_UNSG,SendType.MQTT),"单次关门"),
    REQUEST_ACCESS_DATA(new Command("{0} 03 01 00 00 00",CheckType.SUM_UNSG,SendType.MQTT), "请求门禁数据"),
    OPEN_ACCESS_PERSIST_LOCK(new Command("{0} 0A 01 FF FF 00",CheckType.SUM_UNSG,SendType.MQTT),"长开锁定"),
    OPEN_ACCESS_PERSIST_UNLOCK(new Command("{0} 0A 01 FF 00 00",CheckType.SUM_UNSG,SendType.MQTT),"长开解锁"),
    OPEN_ACCESS_PERSIST_KEEP(new Command("{0} 0A 01 FF 11 00",CheckType.SUM_UNSG,SendType.MQTT),"长开保持原状"),
    CLOSE_ACCESS_PERSIST_LOCK(new Command("{0} 0A 01 00 FF 00",CheckType.SUM_UNSG,SendType.MQTT),"长关锁定"),
    CLOSE_ACCESS_PERSIST_UNLOCK(new Command("{0} 0A 01 00 00 00",CheckType.SUM_UNSG,SendType.MQTT),"长关解锁"),
