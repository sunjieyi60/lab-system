...
-- Demo schema for scheduler (simplified)
CREATE TABLE IF NOT EXISTS task_group (
    id BIGINT PRIMARY KEY,
    name VARCHAR(128) NOT NULL,
    cron_expr VARCHAR(64) NOT NULL,
...
INSERT INTO data_group (id, name, type, fetch_config, agg, enable) VALUES
(100, '室内温度', 'TEMPERATURE', JSON_OBJECT('deviceId','temp-001','metric','temp','windowMinutes',5,'agg','AVG'), 'AVG', 1),
(101, '室内光照', 'LIGHT', 'null', 'AVG', 1);

-- condition_group logic=ALL
INSERT INTO condition_group (id, group_id, logic, enable) VALUES
(200, 1, 'ALL', 1);
