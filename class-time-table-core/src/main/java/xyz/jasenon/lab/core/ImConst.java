...
public interface ImConst
{
	...
	interface Http{
	 	...
	 	*Accept-Language : zh-CN,zh;q=0.8
		 ...
		 ClassTimeTable-Agent : Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36
		 ...
		 */
		 interface RequestHeaderKey {
			...
			String User_Agent = "ClassTimeTable-Agent".toLowerCase(); //Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3088.3 Safari/537.36
